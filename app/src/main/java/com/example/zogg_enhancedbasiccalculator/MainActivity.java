package com.example.zogg_enhancedbasiccalculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnSubtraction:
                txtAnswer.setText(Double.toString(doSubstraction(op1, op2)));
    ...
    public static double doSubstraction(double operand1, double operand2) {
        double answer = 0.0;
        answer = operand1 - operand2;
        return answer;
    }
